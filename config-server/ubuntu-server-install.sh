...
echo "Assuming your desired CRIO_VERSION is $CRIO_VERSION and you operate on UBUNTU 22.04 or 20.04 "
...
echo "Starting Crio services, Start Crio on startup"
systemctl enable crio.service
systemctl start crio.service
echo "Install cri-tools"
echo "Install more prequisits"
...
echo "Kubelet was installed and started check status with 'systemctl status kubelet'"
echo "Join an existing cluster with by running 'kubeadm token create --print-join-command' on master node"